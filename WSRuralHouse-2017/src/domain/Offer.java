...
public class Offer implements Serializable {
	...
	private boolean offerStatus; // true= reservada
	public User offOwner;// Owner of the offer
	@XmlIDREF
	private RuralHouse ruralHouse;

	public Offer(User owner, Date firstDay, Date lastDay, float price, RuralHouse ruralHouse){
		this.offOwner=owner;  
	...
	public void OffOwner(User owner){
		this.offOwner=owner;
	}
	/**
	...
	public String toString(){
		return price+"€;"+ruralHouse.getCity()+";"+firstDay.toString();
	}
}